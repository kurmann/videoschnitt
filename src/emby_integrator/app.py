...
from emby_integrator.media_scanner import scan_media_directory  # Importiere die neue Funktion
import xml.etree.ElementTree as ET  # Hinzugefügt für XML-Verarbeitung
...
@app.command(name="scan-media")
def scan_media_command(
    media_dir: Path = typer.Argument(..., help="Pfad zum Verzeichnis, das gescannt werden soll"),
    json_output: bool = typer.Option(False, "--json", "-j", help="Gebe die Ausgabe im JSON-Format aus")
):
    """
